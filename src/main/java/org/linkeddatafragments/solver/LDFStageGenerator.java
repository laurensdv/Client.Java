 ...
 */
public class LDFStageGenerator implements StageGenerator {
    // Using OpExecutor is preferred.
    StageGenerator above = null;

    public LDFStageGenerator(StageGenerator original) {
        above = original;
    }
    ...
    public QueryIterator execute(BasicPattern pattern, QueryIterator input,
        ...
        return SolverUtil.solve(pattern, input, execCxt, graph, new SolverUtil.BasicGraphSolverExecutor() {
